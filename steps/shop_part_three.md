...
Okay, lets start where we left off in the last module. We have built our models, views and URL's. However, in our views we're referencing a file called utils.py that doesn't exist yet. 
