...
class OrderView(generic.DetailView):
    ...
    **Template:**
    ...
    def dispatch(self, *args, **kwargs):
        return super().dispatch(*args, **kwargs)
```
You will notice that we are referencing a decorators.py file that we have not created yet. Go ahead and create a file called decorators.py in /ecommerce and use the following code.
